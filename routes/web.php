...
// TODO: Authenticate all users to this endpoint. Redirect base on roles and permissions
Route::group(['prefix' => 'auth'], function () {
    ...
    Route::post('register-user', [AuthenticationController::class, 'store_registration'])->name('register-user');
