        ...
        <div class="position-relative">
          ...
          <div class="profile-img-container d-flex align-items-center">
            ...
            <div class="profile-title ms-3">
              <h2 class="text-white">{{$employee->employee_name}}</h2>
              <p class="text-white">{{$employee->qualification}}</p>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="mt-2">
              ...
              <p class="card-text">{{$employee->created_at->diffForHumans() }}</p>
            </div>
            {{-- <div class="mt-2">
